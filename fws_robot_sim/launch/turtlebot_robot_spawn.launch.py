...
def generate_launch_description():
    ...
    turtlebot_robot_description_path = os.path.join(
    ...
    gazebo_resource_path = SetEnvironmentVariable(
        ...
        value=[
            ...
            str(Path(turtlebot_robot_description_path).parent.resolve())
            ]
        )
    ...
    xacro_file = os.path.join(turtlebot_robot_description_path,
                              'urdf',
                              'standard',
